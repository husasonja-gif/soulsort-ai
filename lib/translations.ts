...
const translations: Record<string, Partial<Record<LanguageCode, string>>> = {
  ...
  'bmnl.q2': {
    en: 'Which event principle feels easiest for you to live by — and which one feels most challenging?',
    nl: 'Welk eventprincipe voelt het gemakkelijkst voor je om naar te leven — en welk voelt het meest uitdagend?',
    de: 'Welches Event-Prinzip fühlt sich für dich am einfachsten zu leben — und welches am herausforderndsten?',
    fr: 'Quel principe d\'événement vous semble le plus facile à vivre — et lequel vous semble le plus difficile?',
    es: '¿Qué principio del evento te resulta más fácil de vivir — y cuál te resulta más desafiante?',
    it: 'Quale principio dell\'evento ti sembra più facile da vivere — e quale ti sembra più impegnativo?',
    pt: 'Qual princípio do evento parece mais fácil para você viver — e qual parece mais desafiador?',
  },
  'bmnl.q3': {
    en: 'Have you attended consent-forward or community-led events before? If so, which ones?',
    nl: 'Heb je eerder consent-forward of community-led evenementen bijgewoond? Zo ja, welke?',
    de: 'Hast du schon einmal consent-forward oder community-led Veranstaltungen besucht? Wenn ja, welche?',
    fr: 'Avez-vous déjà assisté à des événements centrés sur le consentement ou pilotés par la communauté? Si oui, lesquels?',
    es: '¿Has asistido antes a eventos centrados en el consentimiento o liderados por la comunidad? Si es así, ¿cuáles?',
    it: 'Hai mai partecipato a eventi orientati al consenso o guidati dalla comunità? Se sì, quali?',
    pt: 'Você já participou de eventos focados em consentimento ou liderados pela comunidade? Se sim, quais?',
  },
  'bmnl.q4': {
    en: 'These environments can be intense. How do you respond when you\'re tired, overstimulated, or out of your comfort zone in a group?',
    nl: 'Deze omgevingen kunnen intens zijn. Hoe reageer je als je moe, overprikkeld of buiten je comfortzone bent in een groep?',
    de: 'Diese Umgebungen können intensiv sein. Wie reagierst du, wenn du müde, überreizt oder außerhalb deiner Komfortzone in einer Gruppe bist?',
    fr: 'Ces environnements peuvent être intenses. Comment réagissez-vous lorsque vous êtes fatigué, surstimulé ou hors de votre zone de confort dans un groupe?',
    es: 'Estos entornos pueden ser intensos. ¿Cómo respondes cuando estás cansado, sobreestimulado o fuera de tu zona de confort en un grupo?',
    it: 'Questi ambienti possono essere intensi. Come reagisci quando sei stanco, sovrastimolato o fuori dalla tua zona di comfort in un gruppo?',
    pt: 'Esses ambientes podem ser intensos. Como você responde quando está cansado, superestimulado ou fora da sua zona de conforto em um grupo?',
  },
  'bmnl.q5': {
  ...
  'bmnl.q10': {
    en: 'What would you like to gift to this event community (time, skills, care, creativity)?',
    nl: 'Wat zou je graag willen geven aan deze event-community (tijd, vaardigheden, zorg, creativiteit)?',
    de: 'Was möchtest du dieser Event-Community schenken (Zeit, Fähigkeiten, Fürsorge, Kreativität)?',
    fr: 'Qu\'aimeriez-vous offrir à cette communauté d\'événement (temps, compétences, soins, créativité)?',
    es: '¿Qué te gustaría regalar a esta comunidad del evento (tiempo, habilidades, cuidado, creatividad)?',
    it: 'Cosa vorresti regalare a questa community dell\'evento (tempo, abilità, cura, creatività)?',
    pt: 'O que você gostaria de oferecer a esta comunidade do evento (tempo, habilidades, cuidado, criatividade)?',
  },
  'bmnl.q11': {
